...
class RokuMediaPlayer(RokuEntity, MediaPlayerEntity):
    ...
    def state(self) -> str:
        ...
        if self.coordinator.data.app.name == "Power Saver" or self.roku.device.app.screensaver:
            return STATE_IDLE
    ...
    def media_content_type(self) -> str:
        ...
        if self.coordinator.data.app is None or self.coordinator.data.app.name in ("Power Saver", "Roku"):
            return None
